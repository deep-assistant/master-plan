...
- **[telegram-bot](https://github.com/deep-assistant/telegram-bot/blob/main/ARCHITECTURE.md)** - Dual-language Telegram bot (Python/JavaScript) - [JS Translation Status](./TELEGRAM_BOT_JAVASCRIPT_STATUS.md) ✅
